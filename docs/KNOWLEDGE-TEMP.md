...
**Standard Categories**:
- `line` - LINE LIFF, LINE OA, LINE Platform integration
- `database` - Supabase, PostgreSQL, SQL migrations, queries
...
- `frontend` - React, Next.js, shadcn/ui, LINE WebView
- `backend` - Node.js, APIs, JWT authentication
- `calculator` - Pricing logic, tiered pricing, plant catalog
- `auth` - LINE LIFF authentication, JWT bridge
