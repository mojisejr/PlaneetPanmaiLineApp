...
This directory contains GitHub agents that implement the Praneet Panmai LINE App workflow system with hallucination prevention, comprehensive validation, and structured knowledge management.
...
```bash
/plan "Add LINE LIFF authentication bridge"
```
Agent will:
1. Analyze existing LINE LIFF auth system
2. Check LINE SDK dependencies
3. Verify JWT bridge patterns
